            ...
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-2xl p-8 backdrop-blur-sm border border-gray-700">
              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a href="mailto:sambitmallick.soccer@gmail.com" className="text-white hover:text-cyan-400 transition-colors">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <a href="tel:+919088153107" className="text-white hover:text-purple-400 transition-colors">
                      +91 9088153107
                    </a>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-8 border-t border-gray-700">
                ...
                <div className="flex space-x-4">
                  <a
                    href="#"
                    className="p-3 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full hover:scale-110 transition-transform duration-200"
                  >
                    <Linkedin className="w-5 h-5 text-white" />
                  </a>
                  <a
                    href="#"
                    className="p-3 bg-gradient-to-r from-gray-700 to-gray-800 rounded-full hover:scale-110 transition-transform duration-200"
                  >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 bg-slate-700/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:border-cyan-400 focus:outline-none transition-colors resize-none"
              ...
              <button
                type="submit"
                className="w-full px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-500 text-white rounded-lg hover:scale-[1.02] transition-transform duration-200 font-semibold flex items-center justify-center"
              >
